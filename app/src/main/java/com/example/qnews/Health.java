 ...
 * Use the {@link Health#} factory method to
 * create an instance of this fragment.
 */
public class Health extends Fragment {

    private  static final String url="https://newsapi.org/v2/top-headlines?country=in&category=health&apiKey=1d108bbe3e8d4966924a2d01d9e8c930";
    RecyclerView recviewHealth;
    myAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        progressHealth= (ProgressBar) v.findViewById(R.id.progressHealth);
        progressHealth.setVisibility(View.VISIBLE);
        recviewHealth= (RecyclerView) v.findViewById(R.id.recviewHealth);
        recviewHealth.setLayoutManager(new LinearLayoutManager(context));
        newsArray= new ArrayList<>();
        requestQueue= VolleySingleton.getmInstance(context).getRequestQueue();
        adapter= new myAdapter(context);
        recviewHealth.setAdapter(adapter);
    ...
    private void processData() {
        JsonObjectRequest jsonObjectRequest= new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    progressHealth.setVisibility(View.GONE);
