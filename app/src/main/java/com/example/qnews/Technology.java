 ...
 * Use the {@link Technology#} factory method to
 * create an instance of this fragment.
 */
public class Technology extends Fragment {


    private  static final String url="https://newsapi.org/v2/top-headlines?country=in&category=technology&apiKey=1d108bbe3e8d4966924a2d01d9e8c930";

    RecyclerView recviewTech;
    myAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        progressTech= (ProgressBar)v.findViewById(R.id.progressTech);
        progressTech.setVisibility(View.VISIBLE);
        recviewTech= (RecyclerView) v.findViewById(R.id.recviewTech);
        recviewTech.setLayoutManager(new LinearLayoutManager(context));
        newsArray= new ArrayList<>();
        requestQueue= VolleySingleton.getmInstance(context).getRequestQueue();
        adapter= new myAdapter(context);
        recviewTech.setAdapter(adapter);
