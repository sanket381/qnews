 ...
 * Use the {@link sports#} factory method to
 * create an instance of this fragment.
 */
public class sports extends Fragment {

    private  static final String url="https://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=1d108bbe3e8d4966924a2d01d9e8c930";
    RecyclerView recviewSports;
    myAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        progressSport= (ProgressBar)v.findViewById(R.id.progressSport);
        progressSport.setVisibility(View.VISIBLE);
        recviewSports= (RecyclerView) v.findViewById(R.id.recviewSports);
        recviewSports.setLayoutManager(new LinearLayoutManager(context));
        newsArray= new ArrayList<>();
        requestQueue= VolleySingleton.getmInstance(context).getRequestQueue();
        adapter= new myAdapter(context);
        recviewSports.setAdapter(adapter);
    ...
    private void processData() {
        JsonObjectRequest jsonObjectRequest= new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    progressSport.setVisibility(View.GONE);
